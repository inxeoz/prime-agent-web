...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how Prime Agent Web looks and which language it uses.",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Prime Agent Web built-in sub-agents",
    "agents.builtInDescription": "Provides Prime Agent Web's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "appUpdate.releaseNotes": "Prime Agent Web v{version} is available. View release notes",
    ...
    "i18n.attentionNeeded": "Prime needs your attention",
