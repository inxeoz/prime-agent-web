...
function PiWebTitle() {
  ...
  const target = showVersion ? `${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.0.0"}p${process.env.NEXT_PUBLIC_PRIME_VERSION ?? process.env.NEXT_PUBLIC_PI_VERSION ?? "0.0.0"}` : "Prime Web";
