...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how Prime Web looks and which language it uses.",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Prime Web built-in sub-agents",
    "agents.builtInDescription": "Provides Prime Web's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "appUpdate.releaseNotes": "Prime Web v{version} is available. View release notes",
